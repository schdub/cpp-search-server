...
void TestMatchDocumentsSeqAndPar() {
    SearchServer search_server("and with"s);
...
void TestFindDocumentsParAndSeq() {
    SearchServer search_server("and with"s);
...
void Benchmark_FindTopDocuments_seq_par() {
    mt19937 generator;
...
void AllTests() {
    ...
    TestFindDocumentsParAndSeq();

    cout << "//////////////////////////////////////////////////////////////" << endl;

    Benchmark_FindTopDocuments_seq_par();
}
